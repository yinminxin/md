...
![image-20200723084938533](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723090100.png)
...
![image-20200723085009215](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723090107.png)
...
![image-20200723085117356](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723090111.png)
...
![image-20200723085230540](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723090117.png)
...
![image-20200723085402549](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723090125.png)
...
![image-20200723085610786](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723090152.png)
...
![image-20200723085744380](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723090134.png)

而在大量读的场景下（100 万次 get 操作），CopyOnWriteArray 又比同步的 ArrayList 快五倍以上：

![image-20200723085759228](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723090137.png)
...
>那个threadlocal用完把它值清了，还用它干嘛，不是多此一举么？
>
>作者回复: 清的目的是一可以防止内存泄露，二可以防止其它线程拿到不属于这个线程的资源，ThreadLocal里的资源只能给当前线程用，不能被别的线程读到。但是不代表完全没有用。
