...
![image-20200723101911369](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723101913.png)
...
![image-20200723101931061](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723101934.png)
...
[23:17:21.082] [http-nio-45678-exec-1] [DEBUG] [o.s.orm.jpa.JpaTransactionManager       :420 ] - uspending current transaction, creating new transaction with name [org.geekbang.time.commonmistakes.transaction.demo3.SubUserService.createSubUserWithExceptionRight]
...
![image-20200723102001404](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723102003.png)
...
2. 在第一节中我们提到，如果要针对 private 方法启用事务，动态代理方式的 AOP 不可行，需要使用静态织入方式的 AOP，也就是在编译期间织入事务增强代码，可以配置 Spring 框架使用 AspectJ 来实现 AOP。你能否参阅 Spring 的文档“Using @Transactional with AspectJ”试试呢？注意：AspectJ 配合 lombok 使用，还可能会踩一些坑。
