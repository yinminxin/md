...
![image-20200724102954922](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200724102957.png)
...
![image-20200724103022263](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200724103025.png)

- error==2 的用例模拟 userId 参数为空的情况，收单服务会因为缺少 userId 参数提示非法用户。这时，可以把响应体中的 message 展示给用户，这是第二层处理。

![image-20200724103044226](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200724103046.png)

- error==3 的用例模拟 userId 为 1 的情况，因为用户有风险，收单服务调用订单服务出错。处理方式和之前没有任何区别，因为收单服务会屏蔽订单服务的内部错误。

![image-20200724103102260](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200724103104.png)
...
![image-20200724103117927](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200724103120.png)
...
![image-20200724103150114](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200724103152.png)
...
![image-20200724103500024](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200724103502.png)
...
>   作者回复: 
>
>   1. 可以开发一个独立的错误码服务，实现转码、分类、收敛逻辑，甚至可以开发后台，让产品来录入需要的错误码提示消息。阿里的Java开发手册中也有提到相关错误码的一些推荐的最佳实践。
>
