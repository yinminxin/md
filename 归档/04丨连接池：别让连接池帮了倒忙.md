...
![image-20200723094119514](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723094122.png)
...
![image-20200723094338216](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723094340.png)
...
![image-20200723094559516](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723094602.png)
...
![image-20200723094616050](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723094618.png)

好在有了空闲连接回收的策略，60 秒之后连接处于 CLOSE_WAIT 状态，最终彻底关闭。

![image-20200723094635736](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723094638.png)
...
![image-20200723094730827](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723094733.png)
...
![image-20200723094753631](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723094755.png)

也就是说，每次都是新的 TCP 连接，放开 HTTP 这个过滤条件也可以看到完整的 TCP 握手、挥手的过程：

![image-20200723094815892](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723094818.png)
...
![image-20200723094841069](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723094843.png)
...
![image-20200723094936872](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723094939.png)

使用 wrk 对应用进行压测，可以看到连接数一下子从 0 到了 10，有 20 个线程在等待获取连接：

![image-20200723095000216](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723095002.png)
...
![image-20200723095114367](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723095116.png)
...
> 从文档中得知，MongoClient 对象的正确使用姿势应该是：使用 MongoClients.create()（或者其他有参） 方法创建，并再整个应用程序中使用它。

> 问题1，第一个参数是客户端与连接池交互的关键参数，这个参数的取值与客户端的需求紧密相关。第二个参数是连接池与服务器交互的关键参数，这个参数的取值应该参考服务器的一般情况。