...
item.setDeliveryPrice(item.getPrice().multiply(BigDecimal.valueOf(item.getQuantity())).multiply(new BigDecimal("0.1")));
        ...
        //计算运费总价cart.setTotalDeliveryPrice(cart.getItems().stream().map(Item::getDeliveryPrice).reduce(BigDecimal.ZERO, BigDecimal::add));
    
        //计算总优惠   cart.setTotalDiscount(cart.getItems().stream().map(Item::getCouponPrice).reduce(BigDecimal.ZERO, BigDecimal::add));
...
![image-20200723163437332](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723163439.png)
...
![image-20200723163535932](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723163537.png)

![image-20200723163550897](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723163553.png)
