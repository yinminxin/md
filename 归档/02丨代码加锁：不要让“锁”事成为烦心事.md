...
![image-20200723090818789](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723090821.png)
...
![image-20200723091229183](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723091231.png)
...
![image-20200723091352450](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723091355.png)
...
![image-20200723091601909](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723091604.png)
...
![image-20200723091639339](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723091641.png)

查看抓取出的线程栈，在页面中部可以看到如下日志：

![image-20200723091713136](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723091715.png)
...
![image-20200723091750131](https://hankun-abyss.oss-cn-shanghai.aliyuncs.com/image2020/20200723091752.png)
...
>
>
>1.不能退出。必须加volatile，因为volatile保证了可见性。改完后会强制让工作内存失效。去主存拿。如果不加volatile的话那么在while true里面添加输出语句也是OK的。因为println源码加锁了，sync会让当前线程的工作内存失效。
>解释的对吗？献丑了。
>
>作者回复: 嗯必须加volatile或者使用AtomicBoolean/AtomicReference等也行，后者相比volatile除了确保可见性还提供了CAS方法保证原子性，不建议使用其它投机的方式
